...
from datasets.coco_segm_shift import COCOSEGMSHIFT, COCO_eval_segm_shift
...
from utils.losses import _neg_loss, _reg_loss, smooth_reg_loss, mse_reg_loss
from utils.summary import create_summary, create_logger, create_saver, DisablePrint
from utils.post_process import ctsegm_shift_decode

# Training settings
parser = argparse.ArgumentParser(description='simple_centernet_segm_shift')
        ...
        with torch.no_grad():
            for inputs in val_loader:
                ...
                for scale in inputs:
                    ...
                    segms = ctsegm_shift_decode(*output, torch.from_numpy(dictionary.astype(np.float32)).to(cfg.device),
                                                K=cfg.test_topk)
