...
class PoseResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out = [[self.hmap(inmodal_x), self.regs(inmodal_x), self.w_h_(inmodal_x), xc_1, xc_2, xc_3, offsets, activated_codes]]
        return out
