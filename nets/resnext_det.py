...
class BackboneResNeXt(nn.Module):
    def __init__(
            self,
        ...
        super(BackboneResNeXt, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        ...
        # add deconv layers and subsequent layers
    ...
    def init_weights(self, num_layers=101):
        if num_layers == 50:
            model_name = 'resnext50_32x4d'
        elif num_layers == 101 or num_layers is None:
            model_name = 'resnext101_32x8d'
        else:
            print('We are currentlu only supporting ResNeXt-50 and 101.')
...
def get_resnext(num_layers, head_conv=64, num_classes=80, **kwargs):
    ...
    model = BackboneResNeXt(block_class, layers, head_conv=head_conv, num_classes=num_classes, **kwargs)
