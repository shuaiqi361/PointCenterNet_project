    ...
    def train(epoch):
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            if cfg.code_loss == 'norm':
                codes_loss = (norm_reg_loss(c_1, batch['codes'], batch['ind_masks'], sparsity=0.01)
                              + norm_reg_loss(c_2, batch['codes'], batch['ind_masks'], sparsity=0.01)
                              + norm_reg_loss(c_3, batch['codes'], batch['ind_masks'], sparsity=0.01)) / 3.
