...
from datasets.coco_segm_shift_code import COCOSEGMSHIFT, COCO_eval_segm_shift
...
from utils.losses import _neg_loss, _reg_loss, smooth_reg_loss, norm_reg_loss, mse_reg_loss
from utils.summary import create_summary, create_logger, create_saver, DisablePrint
from utils.post_process import ctsegm_shift_code_decode

# Training settings
parser = argparse.ArgumentParser(description='simple_resdcn_iterative_codes')
...
def main():
    ...
    def train(epoch):
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            codes_1 = [_tranpose_and_gather_feature(r, batch['inds']) for r in codes_1]
            codes_2 = [_tranpose_and_gather_feature(r, batch['inds']) for r in codes_2]
            codes_3 = [_tranpose_and_gather_feature(r, batch['inds']) for r in codes_3]
            ...
            if batch_idx % cfg.log_interval == 0:
                ...
                print('[%d/%d-%d/%d] ' % (epoch, cfg.num_epochs, batch_idx, len(train_loader)) +
                      ' hmap_loss= %.3f reg_loss= %.3f offset_loss= %.3f  code_loss= %.3f' %
