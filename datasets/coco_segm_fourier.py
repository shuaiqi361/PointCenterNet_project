...
class COCO_eval_segm_fourier(COCOSEGMFOURIER):
    def __init__(self, data_dir, dictionary_file, split, test_scales=(1,), test_flip=False, fix_size=False):
        super(COCO_eval_segm_fourier, self).__init__(data_dir, dictionary_file, split)
