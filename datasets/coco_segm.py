...
class COCOSEGM(data.Dataset):
    def __init__(self, data_dir, dictionary_file, split, split_ratio=1.0, img_size=512):
        ...
        self.data_rng = np.random.RandomState(98)
    ...
    def __getitem__(self, index):
        ...
        w_h_std = np.zeros((self.max_objs, 2), dtype=np.float32)  # width and height of the shape
        ...
        return {'image': img, 'codes': codes_,
                'hmap': hmap, 'w_h_std': w_h_std, 'regs': regs, 'inds': inds, 'ind_masks': ind_masks,
