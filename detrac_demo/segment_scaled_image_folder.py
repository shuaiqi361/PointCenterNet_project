...
from utils.post_process import ctsegm_decode, ctsegm_scale_decode_debug
    ...
    for annotation in all_anns:
        ...
        with torch.no_grad():
            ...
            for scale in imgs:
                ...
                segms, codes_ = ctsegm_scale_decode_debug(*output, torch.from_numpy(dictionary.astype(np.float32)).to(cfg.device),
                                            K=cfg.test_topk)
